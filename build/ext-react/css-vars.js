...
__rt_setDynamic("$main_theme", __rt_getGlobalDefault("$main_theme") || __ColorRGBA.fromHex("#00C160"), 1);
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __rt_get("$main_theme"), 2);
...
__rt_setDynamic("$dataview_item_selected_background_color", __rt_getGlobalDefault("$dataview_item_selected_background_color") || __rt_get("$selected_background_color"), 40);
__rt_setDynamic("$dataitem_selected_background_color", __rt_getGlobalDefault("$dataitem_selected_background_color") || __rt_get("$dataview_item_selected_background_color"), 41);
__rt_setDynamic("$listitem-selected-background-color", __rt_getGlobalDefault("$listitem_selected_background_color") || __rt_get("$dataitem_selected_background_color"), 42);
},
 {
	":root": [
		"dark-mode",
